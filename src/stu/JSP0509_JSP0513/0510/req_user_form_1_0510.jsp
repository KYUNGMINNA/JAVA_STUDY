...
<%--
 	*사용자의 입력값을 서버로 전달하는 방법.
 	1.사용자의 입력 데이터를 서버로 전송하려면 HTML의 form 태그를 사용합니다.
 	2.form 태그의 action 속성에 데이터를 전달받을 페이지 URL 주소를 작성합니다.
 	3.input 태그의 name 속성으로 요청 파라미터의 이름을 지정할 수 있습니다.
 	이름을 지정하실 때는 입력값과 관련있는 이름으로 지정해 주는것이 좋다.
 	
 	
 --%>

<form action="req_user_info_2_0510.jsp">
        아이디: <input type="text" name="id" > <br>
        비밀번호: <input type="password" name="pw" required> <br>

        # 성별 <br> <%-- value 안주면 값 구분 못함 --%>
        <input type="radio" name="gender" value="male"> 남
        <input type="radio" name="gender" value="female"> 여 <br>

        # 취미 <br><%-- value 안주면 값 구분 못함 --%>
