...
print('{}월 {}일은 {}입니다'.format(month,day,anni)) #{} 안에 숫자안넣으면 순서대로 삽입됨


print('{1}월 {2}일은 {0}입니다'.format(month,day,anni)) #{} 안에 숫자넣으면 ,숫자순으로 삽입

#소수점 표현
pi=3.141592
print('원주율은 %.2f입니다.'%pi)
print('원주율은 {:0.2f}입니다.'.format(pi)) ##앞의 0이라는것은 foramt의 첫번째 값이라는 의미 

#f 문자열 포맷팅
#파이썬 3.6버전 이후로 부터 사용할 수 있는 문법
