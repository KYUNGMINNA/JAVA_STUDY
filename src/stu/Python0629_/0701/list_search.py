...
print(points)
# 그냥 sort()만 하면 오름차 정렬
points.sort(reverse=True)    ##reverse=True 를 작성하면 ,내림차 정렬 가능 
#points.reverse()  #정렬 기능이 아니라 , 단순 역순 배치로 ( 먼저 정렬이 되어 있어야 한다 .)
print(points)


#리스트 내의 요소의 단순 유무를 검사하려면  in  키워드
