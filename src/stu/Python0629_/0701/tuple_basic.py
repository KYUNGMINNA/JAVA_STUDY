...
튜플은 상수 리스트 라고 부르며 (수정안됨) () 를 사용하여 표현합니다.
...
print(f'총점은 : {sum}점  , 평균 :{sum/len(points):0.1f}')

#튜플을 만들 때는 () 를 생략 할 수 있습니다.
print('-'*40)

tu=1,3,5,7,9
print(type(tu))

#튜플은 리스트와 마찬가지로 unpackiging이 가능 
n1,n2,n3,n4,n5=tu
...
#tuple이 지원하는 메서드는 index,count 뿐입니다. : 원본을 수정하는 행위가 아니기 때문
