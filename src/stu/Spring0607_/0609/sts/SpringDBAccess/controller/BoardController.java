...
public class BoardController {
	...
	public void content(@RequestParam("boardNo") int boardNo,Model model) {
				// 내가 씀 : equestParam("boardNo") int boardNo
		System.out.println("수정 페이지로 이동 요청! 번호:"+boardNo);

		
		model.addAttribute("article", service.getAtritlce(boardNo));
	...
	public String modify(BoardVO vo) {
		System.out.println("글 수정 요청! 글 번호 : "+vo.getBoardNo());
	...
	public String searchList(@RequestParam("keyword") String keyword,Model model) {
		model.addAttribute("aList",service.searchWriter(keyword));
		return "board/list";
