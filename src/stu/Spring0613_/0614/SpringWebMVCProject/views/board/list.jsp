				...
				<ul class="pagination justify-content-center">
					...
					<c:if test="${pc.prev}">
						<li class="page-item"><a class="page-link"
							href="<c:url value='/board/list?page=${pc.beginPage-1 }&cpp=${pc.paging.cpp}'/>"
					...
					<c:forEach var="pageNum" begin="${pc.beginPage}" end="${pc.endPage}">
						<li class="page-item">
						<a href="<c:url value='/board/list?page=${pageNum}&cpp=${pc.paging.cpp}' />" class="page-link ${pc.paging.page ==pageNum ? 'page-active':''} "
					...
					<c:if test="${pc.next}">
						<li class="page-item"><a class="page-link"
							href="<c:url value='/board/list?page=${pc.endPage+1}&cpp=${pc.paging.cpp}' />"
