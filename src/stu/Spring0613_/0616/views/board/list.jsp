		...
		<div class="col-lg-8">
			<div class="panel-body">
				<h2 class="page-header">
					<span style="color: #643691;">Spring</span>
					 자유 게시판 
						...
						<tr style="color: #643691;">
							...
							<td><a style="margin-top: 0; height: 40px; color: orange;"
							 href="<c:url value='/board/content/${b.boardNo}${pc.makeURI(pc.paging.page)}' />">
									...
									&nbsp;
							<c:if test="${b.newMark}">
															<!-- servlet-config.xml에 매핑이 되어 있어 ,/img로 바로 접근 -->
				...
				<ul class="pagination justify-content-center">
					...
					<c:forEach var="pageNum" begin="${pc.beginPage}" end="${pc.endPage}">
						<li class="page-item">
						<a href="<c:url value='/board/list${pc.makeURI(pageNum)}' />" class="page-link ${pc.paging.page ==pageNum ? 'page-active':''} "
...
<script>
	...
	$(function(){
		...
		//검색창에서 엔터키를 입력 시 이벤트 처리
		$('#keywordInput').keydown(function(e){
			if(e.keyCode ===13){  //키가 13번 이면 실행해라 (13번은 엔터키를 말함)
				$('#searchBtn').click(); //searchBtn 클릭 한 효과 준다
