	...
	<script>
		...
		$(function(){
			...
			function regist(){
				...
				//ajax 폼 전송의 핵심 FormData 객체  :form이 없는데 ,form으로 감싸서 보내기
				...
				*/
				...
				$.ajax({
					...
					contentType:false, //ajax 방식에서 파일을 넘길때는 반드시 false로 처리해야 ->"multipart/form-data"
				...
				$.getJSON(
					...
					function(list){
						...
						<div class="link-inner">
							<a href="##"><i class="glyphicon glyphicon-thumbs-up"></i>좋아요</a>
							<a href="##"><i class="glyphicon glyphicon-comment"></i>댓글달기</a> 
							<a href="`+list[i].bno+`" id=""><i class="glyphicon glyphicon-remove"></i>삭제하기</a>
						</div>`;
						$('#contentDiv').html(str);
		 		...
		 		$.ajax({
					...
					success:function(result){
						if(result ==='noAuth'){
							...
							getList(1,true); //삭제가 반영된 글 목록을 새로벡 보여줘야 하기 대문에 리셋 여부를 true
						}
