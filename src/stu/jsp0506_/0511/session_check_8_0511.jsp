...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%
		/*
			...
			getAttrbute()를 사용하며 , 매개값으로 가져올 세션 데이터의
			이름을 적습니다.
		*/
	
		
		//session.getAttribute()의 리턴타입은 Object이기 때문에
		...
		out.print("세션의 유효시간은 : "+sTime+"초<br>");
		out.print("------------------------------<br>");
		...
		out.print("------------------------------<br>");
	 	...
	 	//모든 세션 데이터를 삭제하는법(무효화)= 해당 페이지에서 세션을 종료
	 	session.invalidate(); //invalidate이후  getAttribute 쓰면 오류
	 	...
	 	out.print("삭제 후 hobbies 값:"+Arrays.toString(hobbies)+"<br>");
		out.print("------------------------------<br>");
